    ...
    <div class="container">
        <div class="moduls-container col-md-12 text-center text-md-start mb-12 align-items-center">
            ...
            <div class="module-grid">
                <div class="module">
                    <img src="../static/images/view_user/Icon-module-register.png" alt="Modulo de Información">
                    <h4>Módulo de Llenado de Información</h4>
                    <p>Llenado/Actualización de información de reportes según el No. Orden proveniente de Softland.</p>
                    <a href="../BaseDatos/LlenadoReportes/edit_informe.php" class="btn btn-primary">Ver Usuarios</a>
                </div>
...
<!--                </div>-->
                ...
                <div class="module">
                    <img src="../static/images/view_user/Icon-module-reports.png" alt="Módulo de Reportes">
                    <h4>Módulo de Reportes</h4>
                    <p>Generación de reportes y gráficos bimestrales o anuales.</p>
                    <a href="user_module-reports.php" class="btn btn-primary">Añadir</a>
                </div>
